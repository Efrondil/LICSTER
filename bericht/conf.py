...
numfig = True    # :numref:`label`

numfig_secnum_depth = (2)
numfig_format = {'figure': 'Abb. %s', 'section': 'Abschnitt %s',
                 'table': 'Tab. %s', 'code-block': 'Codeabschnitt %s'}
...
#
# alabaster.readthedocs.io/en/latest/customization.html
html_theme = 'sphinx_rtd_theme'

# sphinx-rtd-theme.readthedocs.io/en/stable/
# html_theme = "sphinx_rtd_theme"
...
htmlhelp_basename = 'sphinxberichtdoc'
...
latex_documents = [
    (master_doc, 'sphinxbericht.tex', 'LICSTER Projekt SoSe 2020',
     'IDS, Webapp, SecCom', 'manual'),
]
